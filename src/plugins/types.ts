...
export interface GwPlugin {
  ...
  hooks?: {
    ...
    'worktree:removing'?: (ctx: GwContext, wt: WorktreeInfo) => Promise<boolean | undefined>;
    'worktree:removed'?: (ctx: GwContext, info: { name: string; branch: string }) => Promise<void>;
    'worktree:switch'?: (
      ctx: GwContext,
      from: WorktreeInfo | null,
      to: WorktreeInfo,
    ) => Promise<void>;
    'status:extend'?: (ctx: GwContext, wt: WorktreeInfo) => Promise<StatusExtension[]>;
    'prune:shouldRemove'?: (ctx: GwContext, wt: WorktreeInfo) => Promise<boolean | null>;
  };
